        ...
        if(!fromHistory) {
            ...
            if (startAutomatic) {
                ...
                for (int key : activityCount.keySet()) {
                    Log.d("count", key + " " + activityCount.get(key));
                    if (activityCount.get(key) > max_count) {
                        unconverted_type = key;
                        max_count = activityCount.get(key);
                    }
                }

                Log.d("unconverted", String.valueOf(unconverted_type));
                ...
                Log.d("converted", String.valueOf(converted_type));
